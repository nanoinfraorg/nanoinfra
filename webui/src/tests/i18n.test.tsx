...
// The approvals inbox (nanoinfraorg/nanoinfra#27). A human authorizes a remote command here, so
// every sentence has to arrive in the operator's own language.
const LOCALIZED_APPROVALS_KEYS = [
  "sidebar.approvals",
  "sidebar.approvalsBadge",
  "approvals.title",
  "approvals.subtitle",
  ...
  "approvals.timeLeft",
  "approvals.expiresNote",
  "approvals.expired",
  "approvals.from",
  "approvals.payloadTitle",
  "approvals.payloadNote",
  "approvals.hostsTitle",
  "approvals.contextDivider",
  "approvals.context.origin",
  "approvals.context.approve",
  "approvals.context.class",
  "approvals.context.digest",
  "approvals.approveFromValue",
  "approvals.approve",
  "approvals.approveUnavailable",
  // Approve and add (#220). One of these sentences hands out a permanent permission, so an
  // operator who cannot read it cannot judge it.
  "approvals.grant.menuLabel",
  "approvals.grant.menuNote",
  "approvals.grant.add24h",
  "approvals.grant.add7d",
  "approvals.grant.addNever",
  "approvals.grant.permanentTitle",
  "approvals.grant.permanentBody",
  "approvals.grant.permanentConfirm",
  "approvals.grant.saved",
  "approvals.grant.savedPermanent",
  "approvals.grant.notSaved",
  "approvals.deny",
  "approvals.samePath",
  "approvals.denyTerminal",
  "approvals.approved",
  "approvals.denied",
  "approvals.noAnswer",
  "approvals.refusalOther",
  "approvals.refusal.alreadyAnswered",
  "approvals.refusal.digestMismatch",
  "approvals.refusal.expired",
  "approvals.refusal.noSecondPath",
  "approvals.refusal.notAnApprover",
  "approvals.refusal.samePath",
  "approvals.refusal.unauthenticatedPath",
