...
Tags are `latest`, the minor (`1.0`) and the exact version (`1.0.2`), for `linux/amd64`. Pin the exact version in production, so an upgrade is something you do rather than something that happens.
