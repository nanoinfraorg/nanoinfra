...
This directory contains built-in skills that extend nanoinfra's capabilities.
...
When skills reference large local documentation or logs, prefer nanoinfra's built-in
...
| `knowledge` | Search the operator's own documents and cite `path#section` |
