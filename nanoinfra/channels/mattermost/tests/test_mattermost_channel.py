...
from nanoinfra.channels.mattermost.manifest import SETUP_SPEC
...
async def test_group_policy_in_thread_defaults_to_group_policy():
    ...
    assert channel._should_respond_in_channel("@nanoinfra hello", "c1", in_thread=False) is True
    ...
    assert channel._should_respond_in_channel("@nanoinfra hello", "c1", in_thread=True) is True
