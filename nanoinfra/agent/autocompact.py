...
class AutoCompact:
    ...
    # Entries are only popped when a session is reopened, so a session archived and then
    # abandoned kept its slot for the life of the process (HKUDS/nanobot#5664). An evicted entry
    # costs nothing: the summary is also in session.metadata["_last_summary"], the cold path below.
    ...
    def __init__(self, sessions: SessionManager, consolidator: Consolidator,
        ...
        self._summaries: OrderedDict[str, tuple[str, datetime]] = OrderedDict()
