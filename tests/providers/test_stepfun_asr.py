...
from nanoinfra.providers.transcription import StepFunTranscriptionProvider
...
def test_stepfun_in_registry() -> None:
    ...
    assert spec.adapter == "nanoinfra.providers.transcription:StepFunTranscriptionProvider"
