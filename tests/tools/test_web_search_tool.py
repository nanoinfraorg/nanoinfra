...
from nanoinfra.agent.tools.registry import is_tool_error_result
...
async def test_brave_search_retries_rate_limit_once(monkeypatch):
    ...
    monkeypatch.setattr("nanoinfra.agent.tools.web.asyncio.sleep", mock_sleep)
    monkeypatch.setattr(httpx.AsyncClient, "get", mock_get)
...
async def test_tavily_search(monkeypatch):
    ...
    tool = _tool(provider="tavily", api_key="tavily-key", user_agent="nanoinfra-search-test")
...
async def test_keenable_search(monkeypatch):
    ...
    monkeypatch.setattr(httpx.AsyncClient, "post", mock_post)
    tool = _tool(provider="keenable", api_key="keen-key", user_agent="nanoinfra-search-test")
...
async def test_serper_search(monkeypatch):
    ...
    monkeypatch.setattr(httpx.AsyncClient, "post", mock_post)
    tool = _tool(provider="serper", api_key="serper-key", user_agent="nanoinfra-search-test")
...
async def test_bocha_search(monkeypatch):
    ...
    monkeypatch.setattr(httpx.AsyncClient, "post", mock_post)
    tool = _tool(provider="bocha", api_key="bocha-key", user_agent="nanoinfra-search-test")
...
async def test_volcengine_search(monkeypatch):
    ...
    monkeypatch.setattr(httpx.AsyncClient, "post", mock_post)
    tool = _tool(provider="volcengine", api_key="volc-key", user_agent="nanoinfra-search-test")
...
async def test_searxng_search(monkeypatch):
    ...
    monkeypatch.setattr(httpx.AsyncClient, "get", mock_get)
    tool = _tool(provider="searxng", base_url="https://searx.example", user_agent="nanoinfra-search-test")
    result = await tool.execute(query="test")
...
async def test_duckduckgo_search(monkeypatch):
    ...
    monkeypatch.setattr("nanoinfra.agent.tools.web.DDGS", MockDDGS, raising=False)
    import nanoinfra.agent.tools.web as web_mod
...
async def test_jina_search(monkeypatch):
    ...
    monkeypatch.setattr(httpx.AsyncClient, "get", mock_get)
    tool = _tool(provider="jina", api_key="jina-key", user_agent="nanoinfra-search-test")
    result = await tool.execute(query="test")
...
async def test_kagi_search(monkeypatch):
    ...
    monkeypatch.setattr(httpx.AsyncClient, "post", mock_post)
    tool = _tool(provider="kagi", api_key="kagi-key", user_agent="nanoinfra-search-test")
...
async def test_exa_search(monkeypatch):
    ...
    monkeypatch.setattr(httpx.AsyncClient, "post", mock_post)
    tool = _tool(provider="exa", api_key="exa-key", user_agent="nanoinfra-search-test")
    result = await tool.execute(query="test", count=2)
