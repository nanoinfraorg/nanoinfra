...
from nanoinfra.agent.tools.loader import _SKIP_MODULES, ToolLoader
...
def test_web_tools_config_cls():
    from nanoinfra.agent.tools.web import WebFetchTool, WebSearchTool, WebToolsConfig
...
def test_web_fetch_tool_create():
    from nanoinfra.agent.tools.web import WebFetchTool
    mock_config = MagicMock()
    mock_config.web.enable = True
...
def test_my_tool_config_cls():
    from nanoinfra.agent.tools.self import MyTool, MyToolConfig
...
def test_mcp_wrappers_not_discoverable():
    from nanoinfra.agent.tools.mcp import MCPPromptWrapper, MCPResourceWrapper, MCPToolWrapper
