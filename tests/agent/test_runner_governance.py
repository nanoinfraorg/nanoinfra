...
def test_snip_history_drops_orphaned_tool_results_from_trimmed_slice(monkeypatch):
    ...
    monkeypatch.setattr(
        "nanoinfra.agent.context_governance.estimate_prompt_tokens_chain",
    ...
    monkeypatch.setattr(
        "nanoinfra.agent.context_governance.estimate_message_tokens",
...
def test_snip_history_reserves_budget_for_tool_definitions(monkeypatch):
    ...
    monkeypatch.setattr("nanoinfra.agent.context_governance.estimate_prompt_tokens_chain", _estimate)
    token_sizes = {
        "system": 50,
        "old user": 200,
        "old assistant": 200,
...
def test_microcompact_overflow_compacts_to_low_watermark(monkeypatch):
    ...
    monkeypatch.setattr("nanoinfra.agent.context_governance.estimate_prompt_tokens_chain", estimate)
...
def test_snip_history_preserves_user_message_after_truncation(monkeypatch):
    ...
    messages = [
        ...
        {"role": "user", "content": ".nanoinfra的同目录"},
        {
            "role": "assistant",
            "content": None,
