...
async def test_drain_injections_passes_limit_to_callback_when_supported():
    ...
    from nanoinfra.agent.runner import _MAX_INJECTIONS_PER_TURN, AgentRunner
    from nanoinfra.bus.events import InboundMessage
...
async def test_injection_cycles_capped_at_max():
    ...
    from nanoinfra.agent.runner import _MAX_INJECTION_CYCLES, AgentRunner
    from nanoinfra.bus.events import InboundMessage
...
async def test_cron_turn_deferred_while_session_active(tmp_path):
    ...
    from nanoinfra.bus.events import InboundMessage
    from nanoinfra.cron.session_turns import (
...
async def test_pending_queue_preserves_overflow_for_next_injection_cycle(tmp_path):
    ...
    from nanoinfra.agent.loop import AgentLoop
    from nanoinfra.agent.runner import _MAX_INJECTIONS_PER_TURN
    from nanoinfra.bus.events import InboundMessage
    from nanoinfra.bus.queue import MessageBus
...
async def test_drain_injections_on_empty_final_response():
    ...
    from nanoinfra.agent.runner import _MAX_EMPTY_RETRIES, AgentRunner
    from nanoinfra.bus.events import InboundMessage
